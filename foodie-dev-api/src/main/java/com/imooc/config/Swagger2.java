...
public class Swagger2 {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("天天吃货 电商平台项目")                        // 文档页标题
                .contact(new Contact("Csraf",
                        "https://github.com/Csraf",
                        "jangfeng9420@163.com"))         // 联系人信息
                .description("专为天天吃货开发的api文档")          // 详细信息
                .version("1.0.1")                              // 文档版本号
                .termsOfServiceUrl("https://github.com/Csraf") // 网站地址
                .build();
    }
